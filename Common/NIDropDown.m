...
- (id)showDropDown:(UIButton *)onButton height:(CGFloat )height list:(NSArray *)arr imgList:(NSArray *)imgArr direction:(NSString *)direction
{
    ...
    if (self) {
        ...
        [onButton.superview addSubview:self];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   // btnSender.titleLabel.textColor  = [UIColor grayColor];
...
//    [btnSender addSubview:imgView];
    [self.delegate niDropDown:self didSelectIndexPath:indexPath];
}
